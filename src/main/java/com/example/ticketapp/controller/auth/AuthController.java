package com.example.ticketapp.controller.auth;

import com.example.ticketapp.dto.auth.AuthResponse;
import com.example.ticketapp.dto.auth.ForgetPasswordRequest;
import com.example.ticketapp.dto.auth.LoginRequest;
import com.example.ticketapp.dto.auth.RegisterRequest;
import com.example.ticketapp.dto.auth.ResetPasswordRequest;
import com.example.ticketapp.entity.User;
import com.example.ticketapp.security.JwtUtil;
import com.example.ticketapp.service.auth.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegisterRequest request) {
        ...
        return ResponseEntity.ok(new AuthResponse(null, user.getId(), user.getUsername(),
                user.getEmail(), user.getName(), user.getRole().toString(), user.getPhone()));
    }
